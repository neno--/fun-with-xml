...
public class NamespaceDecarationSchemaTest extends XmlTest {
	...
	public void testCase1() throws URISyntaxException {
		assertTrue(validateImplicit("xml/namespace_tests/fileset1/document.xml"));
	}

	// test there is no location attribute in document
	@Test
	public void testCase2() throws URISyntaxException {
		assertFalse(validateImplicit("xml/namespace_tests/fileset2/document.xml"));
	}

	// bad namespace
	@Test
	public void testCase3() throws URISyntaxException {
		assertFalse(validateImplicit("xml/namespace_tests/fileset3/document.xml"));
	}

	// unused namespaces are ignored
	@Test
	public void testCase4() throws URISyntaxException {
		assertTrue(validateImplicit("xml/namespace_tests/fileset4/document.xml"));
	}

	// relative file paths are not working
	@Test
	public void testCase5() throws URISyntaxException {
		assertFalse(validateImplicit("xml/namespace_tests/fileset5/document.xml"));
	}
	...
	public void testCase6() throws URISyntaxException {
		assertFalse(validateImplicit("xml/namespace_tests/fileset6/document.xml"));
	}
	...
	public void testCase7() throws URISyntaxException {
		assertFalse(validateImplicit("xml/namespace_tests/fileset7/document.xml"));
	}

	@Test
	public void testCase8() throws URISyntaxException {
		assertTrue(validateImplicit("xml/namespace_tests/fileset8/document.xml"));
	}
}
